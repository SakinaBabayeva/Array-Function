...
// function idCountry(x){
//     let a = data.filter(item => item.id == x);
//     let newArray = [ ];
//     let b = newArray.push(a);
//     console.log(newArray[0][0].shipAddress.country);
// }
...
// function countryObject (x){
//     let a = data.filter(item => item.shipAddress.country == x);
//     console.log(a);
// }
...
// function idItemFind (x){
//     let a = data.filter(item => item.id == x)
//     let newArray = [ ];
//     let b = newArray.push(a)
//     // console.log(newArray[0][0].shipName,newArray[0][0].shipAddress.country, newArray[0][0].shipAddress.city);
//     console.log(newArray[0][0].shipName);
//     console.log(newArray[0][0].shipAddress.country);
//     console.log(newArray[0][0].shipAddress.city);
// }
...
// function idNumber (x){
//     let a = data.filter(item => item.id == x);
//     let b = data[0].details;
//     let c = [ ];
//     let d = c.push(b);
//     console.log(Object.keys(c[0][0]).length);
// }
...
// function order (x){
//     let a = data.filter(item => item.id == x);
//     let sum = (a[0].details[0].unitPrice - (a[0].details[0].unitPrice * a[0].details[0].discount)) * a[0].details[0].quantity;
//     console.log(sum);
// }